  ...
  return (
    <Router>
      <div className="h-screen flex flex-col bg-gray-950 overflow-hidden text-gray-100">
        {/* Top Navbar */}
        <nav className="flex items-center justify-between px-3 sm:px-6 py-2 sm:py-3 bg-gray-900/90 backdrop-blur-md border-b border-gray-800 shrink-0 z-50">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div>
              ...
              <p className="text-gray-500 text-[10px] sm:text-xs -mt-0.5 tracking-wide hidden sm:block">
          ...
          <div className="flex items-center gap-2">
            <div className="flex items-center gap-1.5 bg-green-500/10 border border-green-500/20 rounded-full px-2 sm:px-3 py-1">
